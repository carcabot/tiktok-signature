...
async function generateSignature() {
  ...
  const secUid = 'MS4wLjABAAAAtBazTpLuo5XSFwEiX3gkaeV4ZY7u071I08MUNFL5B_zZoelUkTWrhCVvxK7LqAkr';

  const tiktokUrl = `https://www.tiktok.com/api/post/item_list/?` +
  ...
  console.log('User-Agent:', result.data.navigator.user_agent.substring(0, 60) + '...');
  console.log('\nSigned URL:', result.data.signed_url.substring(0, 100) + '...');
